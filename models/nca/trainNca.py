...
class TrainNca:
    ...
    def train_step(self, i):
        ...
        x_final_step, loss = self.calculate_loss(
                step_n, diff_loss,overflow_loss,target_loss, aux_target_loss)
        ...
        with torch.no_grad():
            ...
            self.display_output(i, x_final_step, loss)

    def calculate_loss(self, step_n, diff_loss,overflow_loss,target_loss, aux_target_loss):
    ...
    def display_output(self, i, x_final_step, loss):
        if i % 10 == 0:
            clear_output(True)
